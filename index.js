let projectsList = [
    {"title": "Messaging App", "repoLink":"https://github.com/JakeBrowning90/messaging-app-front", "liveLink":"https://messaging-app.fly.dev/", "thumbnail":"img/messagingAppThumbnail.jpg", "desc":"A messaging tool built with the MERN stack (MongoDB, Express, React, Node.js). Create and customize a profile, add other users to your contacts list, and post text messages to your chat history."},
    {"title": "Map Game", "repoLink":"https://github.com/JakeBrowning90/wheres-waldo-front", "liveLink":"https://jakebrowningmapgame.netlify.app/", "thumbnail":"img/mapGameThumbnail.jpg", "desc":"A quiz game built with the MERN stack. Correctly identify U.S. state capitals, reveal interesting trivia on each play session, and update the database by achieving a top 10 score."},
    {"title": "Blog API", "repoLink":"https://github.com/JakeBrowning90/blog-public-frontend", "liveLink":"https://blog-public-frontend.fly.dev/", "thumbnail":"img/blogThumbnail.jpg", "desc":"A MERN blogging app using RESTful API across two front ends. A public site displays posts and comments, and a private site manages post content with a rich text editor. Editing actions are controlled by JWT authentication. "},
